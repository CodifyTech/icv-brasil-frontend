...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'formacao': RouteRecordInfo<'formacao', '/formacao', Record<never, never>, Record<never, never>>,
    'formacao-cadastrar': RouteRecordInfo<'formacao-cadastrar', '/formacao/cadastrar', Record<never, never>, Record<never, never>>,
    'formacao-components-form-formacao': RouteRecordInfo<'formacao-components-form-formacao', '/formacao/components/form-formacao', Record<never, never>, Record<never, never>>,
    'formacao-editar-id': RouteRecordInfo<'formacao-editar-id', '/formacao/editar/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
