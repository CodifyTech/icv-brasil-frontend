...
const userSubjects = ['permission', 'user', 'roles', 'funcionario', 'formacao', 'epi', 'cliente', 'proposta', 'cargo', 'tipodocumento', 'tiposervico', 'escopo', 'ordemservicomaterialequipamento']
